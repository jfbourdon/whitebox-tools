...
pub struct BreachDepressionsSinks {
    name: String,
    description: String,
    toolbox: String,
...
impl BreachDepressionsSinks {
    pub fn new() -> BreachDepressionsSinks {
        // public constructor
        let name = "BreachDepressionsSinks".to_string();
...
impl WhiteboxTool for BreachDepressionsSinks {
